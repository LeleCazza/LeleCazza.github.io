...
\section{SEZIONE: DEFINIZIONE E CODICE}

\begin{frame}[fragile]{TITOLO SLIDE}
    \begin{alertblock}{DEFINIZIONE}
        \begin{minipage}{0.98\linewidth}
            \justifying
            testo definizione\\
...
\begin{lstlisting}[language=Python]
 testo codice con spazio iniziale per ogni riga
\end{lstlisting}
        \end{minipage}
    \end{alertblock}
\end{frame}
...
\section{SEZIONE: CODICE}

\begin{frame}[fragile]{TITOLO SLIDE}
    \begin{alertblock}{TITOLO BLOCCO CODICE}
        \begin{minipage}{0.98\linewidth}
\begin{lstlisting}[language=Python]
 testo codice con spazio iniziale per ogni riga
\end{lstlisting}
