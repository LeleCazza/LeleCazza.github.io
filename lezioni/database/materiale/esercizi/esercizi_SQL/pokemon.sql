-- Dump della struttura del database pokemon
...
CREATE TABLE Rel_Pokemon_Type(
    ...
    CONSTRAINT `FK_Pokemon_Type` FOREIGN KEY (`ID_Pokemon`) REFERENCES `Pokemon` (`ID_Pokemon`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `FK_Type_Pokemon` FOREIGN KEY (`ID_Type`) REFERENCES `Types` (`ID_Type`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE Rel_Trainer_Pokemon(
    ...
    `ID_Pokemon` int,
    PRIMARY KEY(`ID`),
    CONSTRAINT `FK_Trainer_Pokemon` FOREIGN KEY (`ID_Trainer`) REFERENCES `Trainers` (`ID_Trainer`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `FK_Pokemon_Trainer` FOREIGN KEY (`ID_Pokemon`) REFERENCES `Pokemon` (`ID_Pokemon`) ON DELETE CASCADE ON UPDATE CASCADE
);
    
INSERT INTO Pokemon (`ID_Pokemon`, `Pokemon`, `HP`, `Attack`, `Defense`, `Special_Attack`, `Special_Defense`, `Speed`)
VALUES
...
INSERT INTO Trainers (`ID_Trainer`, `Trainer`, `Badges`)
VALUES
    (1, 'Ash', 9),
    (2, 'Brock', 1),
    (3, 'Misty', 2),
...
INSERT INTO Rel_Pokemon_Type (`ID_Pokemon`, `ID_Type`)
VALUES
    (1, 4),
    (1, 8),
    (2, 4),
...
INSERT INTO Rel_Trainer_Pokemon (`ID_Trainer`, `ID_Pokemon`)
VALUES
    (1, 25),
    (1, 3),
    (1, 6),
