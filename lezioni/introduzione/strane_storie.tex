...
\begin{frame}{STRANE STORIE - CREAZIONE DEI DATI (5 MINUTI) }
    \begin{itemize}
...
\begin{frame}{STRANE STORIE - FORMAZIONE DELLE COPPIE (5 MINUTI)}
    \begin{enumerate}
        \item Dividetevi a coppie, posizionandovi uno di fronte all'altro;
    \end{enumerate}
\end{frame}

\begin{frame}{STRANE STORIE - ASSEGNAZIONE DEI DATI (5 MINUTI)} 
    \begin{enumerate}
...
\begin{frame}{STRANE STORIE - CREAZIONE STORIA (15 MINUTI)}
...
\begin{frame}{STRANE STORIE - INDOVINA CHI (2 MINUTI A STORIA )}
    \begin{itemize}
...
\begin{frame}{STRANE STORIE - PUNTEGGI (SEGNARLI ALLA LAVAGNA)}
    \begin{itemize}
