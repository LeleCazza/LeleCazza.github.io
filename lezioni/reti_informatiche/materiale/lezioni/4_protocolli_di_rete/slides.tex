...
\begin{frame}{URL}
    \only<1 | handout:0>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url1.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<2 | handout:0>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url2.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<3 | handout:0>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url3.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<4 | handout:0>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url4.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<5 | handout:1>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url5.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<6 | handout:2>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url6.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<7 | handout:3>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url7.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<8 | handout:4>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url8.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<9 | handout:5>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url9.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<10 | handout:6>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url10.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
    \only<11 | handout:7>{\begin{figure}
        \includegraphics[width=\linewidth]{img/url11.png}
        \caption{{creata con \href{https://www.canva.com/}{Canva}}}
    \end{figure}}
\end{frame}
