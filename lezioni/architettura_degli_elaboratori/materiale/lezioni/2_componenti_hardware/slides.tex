...
\begin{frame}{HARDWARE VS SOFTWARE}
    \begin{alertblock}{DEFINIZIONI}
        \begin{minipage}{0.98\linewidth}
            \begin{itemize}
                \justifying
                \item Il \textbf{SOFTWARE} è l'insieme delle componenti intangibili 
                di elaborazione, ovvero i programmi e i dati che vengono eseguiti da un elaboratore.
                \pause
                \item L' \textbf{HARDWARE} è l'insieme di tutte le parti tangibili, 
...
\begin{frame}{ARCHITETTURA DEGLI ELABORATORI}
    \begin{alertblock}{MODELLI 3D E VR}
        \begin{minipage}{0.98\linewidth}
            \justifying
            \bigskip
            \href{https://www.mozaweb.com/MyLearn/collections?folder=367207&view_type=own&data_view=grid&from_coll_page=1&field=modify_time}{MOZAIK}: 
            Piattaforma web con materiale 3D interattivo. \\
            \bigskip
            \href{https://portal.classvr.com/connect/player/index.cfm\#categoryid=1035193188}{CLASSVR}: 
            Visori per la realtà virtuale immersiva.
        \end{minipage}
    \end{alertblock}
\end{frame}
